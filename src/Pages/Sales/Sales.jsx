...
// استيراد مكونات الـ Dialog والمكونات الإضافية
...
const Visits = () => {
    ...
    // ---- بناء رابط الـ API الخاص بـ sales مع البحث والـ Pagination ----
    ...
    return (
        <div className="container mx-auto py-10">
            ...
            <DataTable
                ...
                data={visits}
                isLoading={isLoading}
                search_auto={false} // إيقاف الفلترة المحلية بالجدول
            />
